...
using DevnotMentor.Api.UnitTest.TestBase;
...
namespace DevnotMentor.Api.UnitTest.Services
{
    public class UserServiceTests
    {
        ...
        protected Mock<ILoggerRepository> mockLoggerRepository = MockRepository.Create<ILoggerRepository>();
